...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    kasper_persona = (
        ...
        "Try to not be repetitive, especially unnecessarily. Remember what you said last to make sure you don't repeat yourself. "
        ...
        "Don't get stuck on topics; you get stuck after 4 or 5 entries. You need longevity; every response has to be relevant to what the user said and not an accidental repeat of what you said before."
    )
