...
COOLDOWN_SECONDS = int(os.getenv("COOLDOWN_SECONDS", "45"))  # Added for flexibility

#######################################
# GPT 4-o Mini Realtime
#######################################
REALTIME_MODEL = "gpt-4-turbo-2024-04-09"  # Replace with your actual model name
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    kasper_persona = (
        ...
        " try to not be repetitive , especially unneccessarily. remember what u said last to make sure u dont repeat yourself " 
